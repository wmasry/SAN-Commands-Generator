...
public class UI extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int f;
                        ...
                        brocadefile.write("##You must review and test the generated configuration before deploying on production/live switches");
			...
			XSSFSheet cfgsheet = workbook.getSheet("CFG");
                ...
                //Start of zone creation             
                      ...
                      XSSFRow rowj = cfgsheet.getRow(1);
                      XSSFCell celljb = rowj.getCell((int) 1);
                      brocadefile.write("cfgenable"+" "+celljb.getStringCellValue());
            ...
            else if (jRadioButton2.isSelected())
            {
                        ...
                        ciscofile.write("##You must review and test the generated configuration before deploying on live/production switches");
                        ciscofile.write("\n");
                        ciscofile.write("\n");
                        FileInputStream fileinputstream = new FileInputStream(jTextField1.getText());
